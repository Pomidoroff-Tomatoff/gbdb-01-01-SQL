...
-- которая возвращает поцизию первого аргумента (id) в списке слудующих далее аргументов (... 5, 1, 2)
-- Такой подход нагляден, так как сохраняет список IN() в списоке аргументов FIELD():
