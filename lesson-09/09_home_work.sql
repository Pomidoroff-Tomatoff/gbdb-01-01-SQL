...
-- Задание А-2 (ТРАНЗАКЦИИ, ПЕРЕМЕННЫЕ, ПРЕДСТАВЛЕНИЯ)
...
-- Задание А-3. (по желанию) (ТРАНЗАКЦИИ, ПЕРЕМЕННЫЕ, ПРЕДСТАВЛЕНИЯ)
...
-- Задание А-4. (по желанию) (ТРАНЗАКЦИИ, ПЕРЕМЕННЫЕ, ПРЕДСТАВЛЕНИЯ)
...
-- Задание В-1 (ХРАНИМЫЕ ПРОЦЕДУРЫ И ФУНКЦИИ, ТРИГГЕРЫ)
